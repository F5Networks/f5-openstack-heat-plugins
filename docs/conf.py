...
project = u'F5 Plugins for OpenStack Heat'
...
.. raw:: html
   ...
   <script type="text/javascript">
    ...
    var rtd = "f5-openstack-heat-plugins.readthedocs.io";

    if (window.location.hostname === rtd) {window.location.assign("http://" + home + "/products/openstack/heat-plugins/liberty");}
   </script>
'''
...
html_title = "F5 Plugins for OpenStack Heat"
...
htmlhelp_basename = 'F5OpenStackHeatPluginsdoc'
...
latex_documents = [
    (master_doc, 'F5OpenStackHeatPlugins.tex',
     u'F5 Plugins for OpenStack Heat Documentation',
...
.. |release-notes| raw:: html
    ...
    <a class="btn btn-success" href="https://github.com/F5Networks/f5-openstack-heat-plugins/releases/tag/v%(version)s/">Release Notes</a>
